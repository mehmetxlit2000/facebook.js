...
// ==UserScript==
// @name         Facebook Registration Automation
...
(async function () {
    ...
    if (firstnameInput) await typeChar(firstnameInput, "deneme");
    if (regEmailInput) await typeChar(regEmailInput, "test@example.com");
